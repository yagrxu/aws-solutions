...
docker tag grafana-demo-hello:latest 613477150601.dkr.ecr.ap-southeast-1.amazonaws.com/grafana-demo-hello:$DOCKER_IMAGE_VERSION
docker push 613477150601.dkr.ecr.ap-southeast-1.amazonaws.com/grafana-demo-hello:$DOCKER_IMAGE_VERSION
