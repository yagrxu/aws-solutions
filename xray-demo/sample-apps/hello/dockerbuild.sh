...
docker tag x-ray-hello-demo:latest 613477150601.dkr.ecr.ap-southeast-1.amazonaws.com/x-ray-hello-demo:$DOCKER_IMAGE_VERSION
docker push 613477150601.dkr.ecr.ap-southeast-1.amazonaws.com/x-ray-hello-demo:$DOCKER_IMAGE_VERSION
